...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#bg { background-color: #<?php echo(get_option($shortname.'_color_bgcolor')); ?>; }
		.post a:link, .post a:visited { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		ul#primary li a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		ul#secondary li a { color: #<?php echo(get_option($shortname.'_color_catslink')); ?>; }
		#sidebar h4 { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		.footer-widget h4.widgettitle { color:#<?php echo(get_option($shortname.'_color_footer_titles')); ?>; }
		#footer a { color:#<?php echo(get_option($shortname.'_color_footer_links')); ?>; }
	</style>
